...
//int id,int index,String name,int number, int class_id
    ...
    public CommonResp insertStudent(@RequestBody StudentInfoForm studentInfoForm) {
        HashMap map = new HashMap();
        map.put("id", studentInfoForm.getId());
        map.put("index",studentInfoForm.getIndex());
         map.put("name",studentInfoForm.getName());
        map.put("number",studentInfoForm.getNumber());
        map.put("class_id",studentInfoForm.getClass_id());
        CommonResp resp = new CommonResp();
